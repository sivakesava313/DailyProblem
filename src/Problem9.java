 ...
 * For example, 2 has “ABC” if we wanted to write anything starting with ‘A’ we need to
 * type key 2 once. If we wanted to type ‘B’, press key 2 twice and thrice for typing ‘C’.
